...
enum {
  ...
  scheme_extflvector_type,              /* 169 */
  scheme_fxvector_type,                 /* 170 */
  scheme_place_type,                    /* 171 */
  scheme_place_object_type,             /* 172 */
  scheme_place_async_channel_type,      /* 173 */
  scheme_place_bi_channel_type,         /* 174 */
  scheme_once_used_type,                /* 175 */
  scheme_serialized_symbol_type,        /* 176 */
  scheme_serialized_keyword_type,       /* 177 */
